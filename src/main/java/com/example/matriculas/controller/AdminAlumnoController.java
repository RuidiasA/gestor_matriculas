...
// ====================================================================
    ...
    public AlumnoDTO actualizar(
        ...
        return adminAlumnoService.actualizar(id, dto);
    }
    ...
    public AlumnoDTO registrar(@Valid @RequestBody RegistrarAlumnoDTO dto) {
        return adminAlumnoService.registrar(dto);
    }

    // ====================================================================
    // 6. ELIMINAR / INACTIVAR
    // ====================================================================
    @DeleteMapping("/{id}")
    @ResponseStatus(HttpStatus.NO_CONTENT)
    public void eliminar(@PathVariable Long id) {
        adminAlumnoService.eliminar(id);
    }
}
